  ...
  <React.Fragment>
    ...
    <Parallax pages={5}>
      ...
      <Content speed={0.4} offset={0}>
        <Hero>
          <BigTitle>
            Hello, <br /> I'm Arash Rowshan.
          </BigTitle>
          <Subtitle>I'm playing around with React and Gatsby today :)</Subtitle>
        </Hero>
      </Content>
      <DividerMiddle
      ...
      <Content speed={0.4} offset={1.2} factor={2}>
        <Inner>
          ...
          <ProjectsWrapper>
            <ProjectCard
              title="UB Bot"
              link="https://arowshan.github.io/UB-Bot/"
              bg="linear-gradient(to right, #D4145A 0%, #FBB03B 100%)"
            >
              This project is something silly I did for unsilly reasons ¯\_(ツ)_/¯
            </ProjectCard>
            <ProjectCard
              title="Deep"
              link="https://www.coursera.org/account/accomplishments/specialization/certificate/PPHC2CLVEB9N"
              bg="linear-gradient(to right, #662D8C 0%, #ED1E79 100%)"
            >
              WOW! Who put my Deep Learning Certification here!!! Remove it before people see it ;)
            </ProjectCard>
            {/* <ProjectCard
              title="Tomb Raider"
              link="https://www.coursera.org/account/accomplishments/specialization/certificate/PPHC2CLVEB9N"
      ...
      <Content speed={0.4} offset={3}>
        <Inner>
          ...
          <AboutHero>
            ...
            <AboutSub>
              I am a solution architect with extensive experience in... blah blah blah. Long story short, you have an idea, make a wish and I make it come true.
              Just like a Genie, except that you pay the Genie in this scenario. I'm also not blue. Everything else pretty much the same though :)
            </AboutSub>
          </AboutHero>
          <AboutDesc>
            You know the way you feel when a puppy smiles at you? Or when two puppies smile at you, or actually when n puppies smile at you as n goes to infinity?
            THAT, is how you'll feel working with me. 
          </AboutDesc>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={4}>
        <Inner>
          ...
          <ContactText>
            Say <a href="mailto:arash.rowshan@gmail.com">Hi</a> or find me on other platforms:{' '}
            <a href="https://www.linkedin.com/in/arash-rowshan-a068b549/">LinkedIn</a> &{' '}
            <a href="https://stackoverflow.com/users/5627217/arash">stackoverflow</a>
          </ContactText>
        </Inner>
        <Footer>
        Credit to Gatsby folks and LekoArts
        </Footer>
      </Content>
